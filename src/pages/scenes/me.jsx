...
const user = {
    ...
    "follows": 2,
    "interests": [
      "Cuando sea grande quiero ser el mejor admin de SnapMsg!!!"
    ],
...
const banner = "https://mobizent.net/wp-content/uploads/2018/04/Home-Four-Banner-Background-Image.png"
